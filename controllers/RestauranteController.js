...
exports.filter = async (req, res) => {
  ...
  const filtros = {
    ...
    precio: req.query.precio ? Number(req.query.precio) : null,
    calificacion: req.query.calificacion ? Number(req.query.calificacion) : null
  };
  ...
  try {
    ...
    console.error(' Error en el controlador de filtros:', error.message);
