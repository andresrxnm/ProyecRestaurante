...
router.get('/create', menuController.create);      // Mostrar formulario de creación
router.post('/', validateMenu, menuController.store); // Guardar nuevo menú
router.get('/:id', menuController.show);           // Mostrar detalles de un menú
router.get('/:id/edit', menuController.edit);      // Mostrar formulario de edición
